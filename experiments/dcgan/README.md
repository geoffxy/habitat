...
The code in this directory is adapted from the PyTorch DCGAN example that can
be found [here](https://github.com/pytorch/examples/tree/master/dcgan). As a
result, it is also licensed under the BSD-3 license (see `LICENSE`).
